...
namespace Newtonsoft.Json.UnityConverters.Tests.ConvertingUnityTypes
{
    ...
    {
        public static (Bounds deserialized, string serialized)[] Representations { get; } = new[] {
    ...
    {
        public static (BoundsInt deserialized, string serialized)[] Representations { get; } = new[] {
