...
namespace Newtonsoft.Json.UnityConverters.Tests.ConvertingUnityTypes
{
    ...
    {
        public static (Vector2 deserialized, string serialized)[] representations = new[] {
    ...
    {
        public static (Vector2Int deserialized, string serialized)[] representations = new[] {
    ...
    {
        public static (Vector3 deserialized, string serialized)[] representations = new[] {
    ...
    {
        public static (Vector3Int deserialized, string serialized)[] representations = new[] {
    ...
    {
        public static (Vector4 deserialized, string serialized)[] representations = new[] {
